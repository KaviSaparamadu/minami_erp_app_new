    ...
    <View style={[tr.row, isEven && tr.rowEven]}>
      ...
      <View style={tr.colName}>
        ...
        <View style={tr.nameBlock}>
          <Text style={tr.nameText} numberOfLines={1}>{employee.employeeName ?? '—'}</Text>
      ...
      <View style={tr.colMeta}>
        <Text style={tr.metaText} numberOfLines={1}>{employee.department ?? '—'}</Text>
        <Text style={tr.metaSub} numberOfLines={1}>{employee.employeeType ?? ''}</Text>
      </View>
...
function EmptyState({ onAdd }: { onAdd(): void }) {
  return (
    <View style={es.wrap}>
      ...
      <Text style={es.title}>No employees yet</Text>
      <Text style={es.sub}>Tap + to add your first employee record</Text>
    </View>
  );
}
      ...
      <View style={styles.sheet}>
        ...
        {filtered.length > 0 && (
          <View style={th.row}>
            ...
            <View style={th.colName}><Text style={th.txt}>Employee</Text></View>
            <View style={th.colMeta}><Text style={th.txt}>Dept / Type</Text></View>
...
const tr = StyleSheet.create({
  ...
  gradeBadge: { alignSelf: 'flex-start', backgroundColor: 'rgba(233,30,99,0.08)', borderRadius: 5, paddingHorizontal: 6, paddingVertical: 2 },
  gradeText:  { fontFamily: FontFamily.bold, fontSize: 9, fontWeight: FontWeight.bold, color: Colors.primaryHighlight, letterSpacing: 0.5 },
